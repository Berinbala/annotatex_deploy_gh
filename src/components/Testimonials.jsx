...
import Client1 from '../assets/tkhurana.jpeg'
                ...
                <div className="grid md:grid-cols-1 gap-x-6 lg:gap-x-12">
                    <div className="mb-12 md:mb-0">
                        <div className="flex justify-center mb-6">
                            <img src={Client1} className="rounded-full shadow-lg w-32" />
                        </div>
                        <h5 className="text-lg font-bold mb-4">Tarasha Khurana</h5>
                        <h6 className="font-medium text-blue-600 mb-4">Ph.D. student at The Robotics Institute, Carnegie Mellon University</h6>
                        <p className="mb-4">
                    ...
                    {/* <div className="mb-12 md:mb-0">
                        <div className="flex justify-center mb-6">
                            <img src={Client2} className="rounded-full shadow-lg w-32" />
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="flex justify-center mb-6">
                            <img src={Client3} className="rounded-full shadow-lg w-32" />
                        </div>
